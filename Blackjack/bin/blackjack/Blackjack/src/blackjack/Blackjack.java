...
//						 firstHand.addCard(firstHand.getCard(0));
						...
						// "C:\\User\\shrisc\\Desktop\\Blackjack\\src\\blackjack\\resources\\Score.txt";
						 String path3= "C:\\Users\\Ivan\\Desktop\\Blackjack\\src\\blackjack\\resources\\Score.txt";
						...
						if (playAgain.equalsIgnoreCase("Y")) {
							...
							if (currentMoney < startMoney) {
								...
								try {
									Files.write(Paths.get(path3), scoreToAdd.getBytes(), StandardOpenOption.APPEND);
								} catch (IOException e) {
			...
			case 2:
				...
				try {
					BufferedReader br = new BufferedReader(
							new FileReader("C:\\Users\\Ivan\\Desktop\\Blackjack\\src\\blackjack\\resources\\Score.txt"));
					String line = "";
					System.out.println(
							"============================================================== Score ==============================================================");
